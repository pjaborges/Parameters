Public Class SingleParam
    Inherits BaseClass(Of Single)

#Region "Constructors"
    ''' <summary>
    ''' Initializes a new instance of the <see cref="SingleParam" /> class. 
    ''' </summary>
    ...
    Public Sub New(isMandatory As Boolean,
                   dftValue As Single,
                   value As Single,
                   Optional acceptVls() As Single = Nothing,
                   Optional rangeVls As Tuple(Of Single, Single) = Nothing)
