Module Exceptions
    ...
    Public Const msg1 As String = "[Error1] Parameter: {0} Value: {1} - Not acceptable."
    Public Const msg2 As String = "[Error2] Parameter: {0} Value: {1} - Is not in the acceptable values."
    Public Const msg3 As String = "[Error3] Parameter: {0} - Not mandatory, default value is missing."
