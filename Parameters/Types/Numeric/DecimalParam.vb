Public Class DecimalParam
    Inherits BaseClass(Of Decimal)

#Region "Constructors"
    ''' <summary>
    ''' Initializes a new instance of the <see cref="DecimalParam" /> class. 
    ''' </summary>
    ...
    Public Sub New(isMandatory As Boolean,
                   dftValue As Decimal,
                   value As Decimal,
                   Optional acceptVls() As Decimal = Nothing,
                   Optional rangeVls As Tuple(Of Decimal, Decimal) = Nothing)
